...
class nnUNetTrainerV2_MCDropout_DecoderOnly(nnUNetTrainer):
    """
    nnU-Net Trainer with MC Dropout ONLY in Decoder for uncertainty estimation
    
    Version: Decoder-only with p=0.5
    This trainer injects Dropout3d layers ONLY into the DECODER for uncertainty estimation.
